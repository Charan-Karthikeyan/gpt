//  Theseus
//  theDetHeuristic.h -- Heuristic for Deterministic Models
//
//  Blai Bonet, Hector Geffner
//  Universidad Simon Bolivar, 1998, 1999, 2000, 2001, 2002

#ifndef _theDetHeuristic_INCLUDE_
#define _theDetHeuristic_INCLUDE_
...
///////////////////////////////////////////////////////////////////////////////
//
// Deterministic Heuristic Class
//

class detHeuristicClass : public heuristicClass
{
...
public:
  ...
  detHeuristicClass( modelClass *m = NULL )
    {
      model = m;
      HTSize = 0;
      solved = NULL;
  ...
  static  detHeuristicClass*  read( istream& is );
  static  detHeuristicClass*  constructor( void );
  static  void                fill( istream& is, detHeuristicClass *heuristic );
};

#endif // _theDetHeuristic_INCLUDE
