...
#ifndef NDEBUG
  static set<char*,less<char*>,single_client_alloc> memoryAllocations;
#endif
...
#if !defined(NDEBUG) && defined(PRINTINFO)
	  fprintf( stderr, "\n" );
#endif
	}
      else
...
#ifndef NDEBUG
template<int inst> 
set<char*,less<char*>,single_client_alloc> __gpt_memory_control<inst>::memoryAllocations;
#endif
