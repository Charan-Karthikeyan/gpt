...
public:
  ...
  map<int,const stateClass::node_t*> shash;
#endif
  ...
  set<int>*       applicationModel;
  map<int,float>* costModel;

  // complex models
  map<int,map<int,float> >* transitionModel;
  map<int,map<int,float> >* observationModel;
  //  map<int,set<int> > invTransitionModel;
